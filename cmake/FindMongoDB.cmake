...
# This module defines
#  MongoDB_INCLUDE_DIRS, where to find mongo/client/dbclient.h
#  MongoDB_LIBRARIES, the libraries needed to use MongoDB.
#  MongoDB_FOUND, If false, do not try to use MongoDB.

if(MongoDB_INCLUDE_DIRS AND MongoDB_LIBRARIES)
   set(MongoDB_FOUND TRUE)

else(MongoDB_INCLUDE_DIRS AND MongoDB_LIBRARIES)

  find_path(MongoDB_INCLUDE_DIRS mongo/client/dbclient.h
      /usr/include/
      /usr/local/include/
      /usr/include/mongo/
...
if(MongoDB_INCLUDE_DIRS AND MongoDB_LIBRARIES)
    set(MongoDB_FOUND TRUE)
    message(STATUS "Found MongoDB: ${MongoDB_INCLUDE_DIRS}, ${MongoDB_LIBRARIES}")
  else(MongoDB_INCLUDE_DIRS AND MongoDB_LIBRARIES)
  ...
  endif(MongoDB_INCLUDE_DIRS AND MongoDB_LIBRARIES)

  mark_as_advanced(MongoDB_INCLUDE_DIRS MongoDB_LIBRARIES)
